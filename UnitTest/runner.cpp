...
CxxTest::StaticSuiteDescription suiteDescription_TestWeb( "/home/lee/github/KQEvent/UnitTest/TestWeb.h", 20, "TestWeb", suite_TestWeb, Tests_TestWeb );

static class TestDescription_suite_TestWeb_TestServer : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_TestWeb_TestServer() : CxxTest::RealTestDescription( Tests_TestWeb, suiteDescription_TestWeb, 28, "TestServer" ) {}
...
#include "/home/lee/github/KQEvent/UnitTest/TestPoll.h"

static TestPoll suite_TestPoll;

static CxxTest::List Tests_TestPoll = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_TestPoll( "/home/lee/github/KQEvent/UnitTest/TestPoll.h", 19, "TestPoll", suite_TestPoll, Tests_TestPoll );

static class TestDescription_suite_TestPoll_TestCloseFdWhenPolling : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_TestPoll_TestCloseFdWhenPolling() : CxxTest::RealTestDescription( Tests_TestPoll, suiteDescription_TestPoll, 21, "TestCloseFdWhenPolling" ) {}
 void runTest() { suite_TestPoll.TestCloseFdWhenPolling(); }
} testDescription_suite_TestPoll_TestCloseFdWhenPolling;
